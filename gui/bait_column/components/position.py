...
def bait_column_position(bait_column):
    ...
    x_scale = Scale(
        ...
        orient=HORIZONTAL, 
        variable=config_view_model['bait']['ui_positions']['select']['x']
    )
    ...
    x_entry = Entry(
        x_container, 
        width=4, 
        textvariable=config_view_model['bait']['ui_positions']['select']['x'],
        validate='key', 
    ...
    y_scale = Scale(
        y_container,
         ...
         orient=HORIZONTAL, 
         variable=config_view_model['bait']['ui_positions']['select']['y']
    )
    ...
    y_entry = Entry(
        y_container, 
        width=4, 
        textvariable=config_view_model['bait']['ui_positions']['select']['y'],
        validate='key', 
