...
def fishing_column_position(fishing_column):
    header_label = Label(fishing_column, text = "Rectangle position (px)")
    header_label.grid(row=0, column=0)

    position_container = LabelFrame(fishing_column)
    ...
    x_scale = Scale(
        ...
        orient=HORIZONTAL, 
        variable=config_view_model['fishing']['left']
        )
    ...
    x_entry = Entry(
        x_container, 
        width=4, 
        textvariable=config_view_model['fishing']['left'],
        validate='key', 
    ...
    y_scale = Scale(
        ...
        orient=HORIZONTAL, 
        variable=config_view_model['fishing']['top']
        )
    ...
    y_entry = Entry(
        y_container, 
        width=4, 
        textvariable=config_view_model['fishing']['top'],
        validate='key', 
