...
def verify_ready_column_position(column):
    ...
    x_scale = Scale(
        ...
        orient=HORIZONTAL, 
        variable=config_view_model['verification']['ready']['region']['left']
        )
    ...
    x_entry = Entry(
        x_container, 
        width=4, 
        textvariable=config_view_model['verification']['ready']['region']['left'],
        validate='key', 
    ...
    y_scale = Scale(
        ...
        orient=HORIZONTAL, 
        variable=config_view_model['verification']['ready']['region']['top']
        )
    ...
    y_entry = Entry(
        y_container, 
        width=4, 
        textvariable=config_view_model['verification']['ready']['region']['top'],
        validate='key', 
